			...
			<div className="mt-4 flex-col flex h-full w-full pb-14">
				{
					...
					chats.map((chat,i)=>(
						...
						className={`md:px-4 px-2 relative py-[14px] hover:bg-gray-200/40 transition-all duration-200 ease-in-out 
					...
					<div className="h-full w-full flex pt-[150px] flex-col items-center">
						<h1 className="text-center text-2xl font-bold">Welcome to your inbox!</h1>
