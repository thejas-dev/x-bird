...
export default function Explore() {
	...
	return (
		<div className="lg:w-[44.6%] md:w-[70%] xs:w-[90%] w-[100%] flex flex-col h-full border-r-[1.3px] border-gray-200 scrollbar-none overflow-y-scroll scroll-smooth">
			...
			<div className="mt-[6px] border-b-[1px] border-gray-200/80 flex items-center w-full overflow-x-scroll md:scrollbar-none scrollbar-none">
				{
					headings.map((head,i)=>(
						<div key={i}
						...
						${currentHeading === head.title ? 'text-black':'text-gray-500'} py-3 md:hover:bg-gray-200/70 
